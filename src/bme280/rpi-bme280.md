...
Two-node weather station using BME280 sensor:

- **Sensor Node:** Raspberry Pi Zero v1.1 (PiOS) or Pi Zero 2W (Ubuntu 24.04) + BME280 + PiSugar battery
- **Display Node:** Raspberry Pi booting to GUI, or any computer with a display
